...
function Manage_T_Shirts() {
  ...
  const fetch_Tshirts = async() => {
    const resp = await axios.get(`http://localhost:3000/t_shirts`);
  ...
  // ---------------| Fetch Shirts Data from JSON-Server and Show in Manage Shirts Table -> END |---------------
   ...
   const delete_Tshirt = async(id) => {
    const resp = await axios.delete(`http://localhost:3000/t_shirts/${id}`);
    if (resp.status == 200) 
    {
      toast.success('T-Shirt Product Deleted Successfully.');
      fetch_Tshirts();
    }
   };
        ...
        <div id="content-wrapper" className="d-flex flex-column">
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              {/* Page Heading */}
              <h1 className="h3 mb-2 text-gray-800 text-center border border-primary py-2 rounded"> Manage T-Shirts </h1>
              <p className="mb-4">
                              ...
                              <tr key={index} align='center'>
                                ...
                                <td>
                                  <div style={{ width: "125px" }}>
                                    <button className="btn-sm btn-primary btn-icon-split mb-1" title="Edit">
                                      <span className="icon">
                                    ...
                                    <button className="btn-sm btn-danger btn-icon-split mb-1" onClick={()=> delete_Tshirt(value.id)} title="Edit">
                                      <span className="icon">
                                    ...
                                    <button className=" btn-sm btn-info btn-icon-split" title="Edit">
                                      <span className="icon">
...
export default Manage_T_Shirts;
