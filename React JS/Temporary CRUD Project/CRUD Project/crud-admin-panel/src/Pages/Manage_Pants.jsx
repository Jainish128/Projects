...
function Manage_Pants() {
  ...
  const fetch_pants = async() => {
    const resp = await axios.get(`http://localhost:3000/pants`);
    setPants(resp.data);
  };
  // ---------------| Fetch Shirts Data from JSON-Server and Show in Manage Shirts Table -> END |---------------
   ...
   const delete_pant = async(id) => {
    const resp = await axios.delete(`http://localhost:3000/pants/${id}`);
    if (resp.status == 200) 
    {
      toast.success('Pant product was deleted successfully.');
      fetch_pants();
    }
   };
        ...
        <div id="content-wrapper" className="d-flex flex-column">
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              {/* Page Heading */}
              <h1 className="h3 mb-2 text-gray-800 text-center border border-primary py-2 rounded"> Manage Pants </h1>
              <p className="mb-4">
                              ...
                              <tr key={index} align='center'>
                                ...
                                <td>
                                  <div style={{ width: "125px" }}>
                                    ...
                                    <button className="btn btn-sm btn-danger btn-icon-split mb-1" onClick={()=> delete_pant(value.id)} title="Edit">
                                      <span className="icon">
