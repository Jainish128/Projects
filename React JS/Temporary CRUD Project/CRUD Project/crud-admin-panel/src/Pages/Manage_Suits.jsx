...
function Manage_Suits() {
  ...
  const fetch_suits = async() => {
    const resp = await axios.get(`http://localhost:3000/suits`);
    setSuits(resp.data);
  };
  // ---------------| Fetch Shirts Data from JSON-Server and Show in Manage Shirts Table -> END |---------------
   ...
   const delete_Suit = async(id) => {
    const resp = await axios.delete(`http://localhost:3000/suits/${id}`);
    if (resp.status == 200) 
    {
      toast.success('Suit product was deleted successfully.');
      fetch_suits();
    }
   };
                              ...
                              <tr key={index} align='center'>
                                ...
                                <td>
                                  <div style={{ width: "125px" }}>
                                    ...
                                    <button className="btn btn-sm btn-danger btn-icon-split mb-1" onClick={()=> delete_Suit(value.id)} title="Edit">
                                      <span className="icon">
