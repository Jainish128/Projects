...
function Manage_Shirts() {
  ...
  // ---------------| Fetch Shirts Data from JSON-Server and Show in Manage Shirts Table -> END |---------------
   ...
   const delete_shirt = async(id) => {
    const resp = await axios.delete(`http://localhost:3000/shirts/${id}`);
    if (resp.status == 200) 
    {
        ...
        <div id="content-wrapper" className="d-flex flex-column">
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              {/* Page Heading */}
              <h1 className="h3 mb-2 text-gray-800 text-center border border-primary py-2 rounded"> Manage Shirts </h1>
              <p className="mb-4">
                              ...
                              <tr align='center' key={index} >
                                ...
                                <td>
                                  <div style={{ width: "125px" }}>
                                    ...
                                    <button className="btn btn-sm btn-danger btn-icon-split mb-1" onClick={()=> delete_shirt(value.id)} title="Edit">
                                      <span className="icon">
                                        <i className="fa-regular fa-trash-can"></i>
                                      </span>
                                      <span className="text"> Delete </span>
